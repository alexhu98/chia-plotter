				...
				const std::string tmp_dir_2)
{
	...
	wait_for_space("P1", tmp_dir_2, 55);
	...
	DiskTable<tmp_entry_x> tmp_2(prefix_3 + "table2.tmp");
	...
	DiskTable<tmp_entry_x> tmp_3(prefix_3 + "table3.tmp");
	...
	wait_for_space("P1", tmp_dir_2, 10);
